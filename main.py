...
logger.info("training model A with x,y,z param, on B image set.")
model = train(train_dir=train_set_0_B_dir, model_type="CPx", use_GPU=True, n_epochs=100, test_dir=test_set_0_B_dir)
...
# test
# logger.info("model A trained with x,y,z param on B image set, testing on C image set")
